            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View className="px-5 py-4 flex-row items-center justify-between border-b border-gray-100">
                    <View className="flex-row items-center gap-4">
                        <View className="items-center">
                            <Text className="text-lg font-bold text-gray-900">{community.memberCount}</Text>
                ...
                {joined && (
                    <View className="px-5 py-3 border-b border-gray-100">
                        <TouchableOpacity
                            onPress={() => navigation.navigate('Chat', { eventId: community.id, eventTitle: community.name })}
                            activeOpacity={0.8}
